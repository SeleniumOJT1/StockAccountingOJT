...
//startBrowser
	...
	public static WebDriver startBrowser(WebDriver driver) throws Throwable
	{
		...
		{
			System.setProperty("webdriver.gecko.driver", "D:\\Vasu11AM\\MavenStockAccounting\\ExecutableFiles\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else 
			if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome"))
			{
				System.setProperty("webdriver.chrome.driver","D:\\Vasu11AM\\MavenStockAccounting\\ExecutableFiles\\chromedriver.exe");
						driver=new ChromeDriver();
			}else
				if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie"))
				{
					System.setProperty("webdriver.ie.driver","D:\\Vasu11AM\\MavenStockAccounting\\ExecutableFiles\\IEDriverServer.exe");
	...
	public static void captureData(WebDriver driver,String locatorType,String locatorValue) throws IOException
	{
		...
		FileWriter fw=new FileWriter("D:\\Vasu11AM\\MavenStockAccounting\\CaptureData\\Data.txt");
	...
	public static void tableValidation(WebDriver driver,String column) throws Throwable
	{
		...
		FileReader fr=new FileReader("D:\\Vasu11AM\\MavenStockAccounting\\CaptureData\\Data.txt");
