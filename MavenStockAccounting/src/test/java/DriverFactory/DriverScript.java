...
public void startTest() throws Throwable
{
	...
	for (int i = 1;i<=excel.rowCount("MasterTestCases");i++)
	{
		...
		if(excel.getData("MasterTestCases", i, 2).equalsIgnoreCase("Y"))
		{
			...
			report=new ExtentReports("D:\\Vasu11AM\\MavenStockAccounting\\Reports\\"+TCModule+FunctionLibrary.generateDate()+".html");
			...
			for (int j =1; j<=rowcount; j++)
			{
				...
				if(Object_Type.equalsIgnoreCase("mouse"))
				{
					FunctionLibrary.mouse(driver);
					logger.log(LogStatus.INFO, Description);
				}
...
FileUtils.copyFile(srcFile, new File("D:\\Vasu11AM\\MavenStockAccounting\\ScreenShots\\"+TCModule+"  "+FunctionLibrary.generateDate()+".png"));
					break;
				}
			}
